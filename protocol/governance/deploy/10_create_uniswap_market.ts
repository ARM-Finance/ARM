...
export default async ({ ethers, getNamedAccounts, deployments }) => {
    ...
    await uniRouter.addLiquidityETH(armToken.address, TARGET_TOKEN_LIQUIDITY, TARGET_TOKEN_LIQUIDITY, TARGET_ETH_LIQUIDITY, admin, deadline, { value: TARGET_ETH_LIQUIDITY, gasLimit: 6000000 })
...
export async function skip({ ethers, deployments, getNamedAccounts }) {
