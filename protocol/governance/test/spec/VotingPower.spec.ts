    ...
    context("Post-Init", async () => {
        ...
        context("stake", async () => {
            it("allows a valid stake", async function() {
                ...
                const totalARMStakedBefore = await votingPower.getARCHAmountStaked(deployer.address)
                ...
                expect(await votingPower.getARCHAmountStaked(deployer.address)).to.eq(totalARMStakedBefore.add(1000))
        ...
        context("stakeWithPermit", async () => {
            it("allows a valid stake with permit", async function() {
                ...
                expect(await votingPower.getARCHAmountStaked(deployer.address)).to.eq(totalARMStakedBefore.add(value))
        ...
        context("withdraw", async () => {
            it("allows a valid withdrawal", async function() {
                ...
                expect(await votingPower.getARCHAmountStaked(deployer.address)).to.eq(totalARMStakedBefore)
